...
clear
echo
echo "# Copyright (c) 2019-2027,by c00007"
echo
...
cat /tmp/yhosts.conf /tmp/mallist > /tmp/noad
echo
echo -e "\e[1;36m 删除dnsmasq、hosts临时文件\e[0m"
rm -rf /tmp/userlist /tmp/ad.conf /tmp/easylistchina.conf /tmp/blacklist /tmp/yhosts.conf /tmp/mallist
echo
